...
export const fallbackContent = {
  settings: {
    ...
    logoUrl: '/logo.png',
    homePromoImageUrl: '/banners/home-ivf-mother.jpg',
    homePromoAlt:
      'Congrats! You are going to be a mother — let your baby dream come true at Kinder Hospitals, with 15 years of IVF legacy. Call +91 484 666 0000.',
    homePromo2ImageUrl: '/banners/kochi-ivf-father.jpg',
    homePromo2Alt:
      'Congrats! You are going to be a father — let your baby dream come true at Kinder Hospitals, with 15 years of IVF legacy. Call +91 484 666 0000.',
    announcement: '',
    stats: [
  ...
  specialities: [
    ...
    // Kinder Kollam's own five departments, as published on kinderkollam.com.
    { id: 101, name: 'Obstetrics', location: 'Kollam', category: 'Maternity & Pregnancy', sortOrder: 101,
      description: 'Complete maternity care from pregnancy to postnatal recovery, including normal and high-risk deliveries, antenatal education, and personalised care in modern, well-monitored labour suites.' },
    { id: 102, name: 'Gynaecology', location: 'Kollam', category: 'Fertility & Gynaecology', sortOrder: 102,
      description: "Complete women's healthcare, including menstrual issues, PCOD/PCOS, fibroids, endometriosis, infertility evaluation, and menopausal care, with precise diagnosis and minimally invasive treatment." },
    { id: 103, name: 'Paediatrics', location: 'Kollam', category: "Children's Care", sortOrder: 103,
      description: 'Dedicated care for infants, children, and adolescents, focusing on vaccinations, growth and development monitoring, early diagnosis, and infection management in a child-friendly, caring environment.' },
    { id: 104, name: 'Neonatology', location: 'Kollam', category: "Children's Care", sortOrder: 104,
      description: 'Specialised care for newborns, including premature and high-risk babies, with advanced neonatal facilities, expert monitoring, and skilled neonatologists.' },
    { id: 105, name: 'Radiology & Diagnostics', location: 'Kollam', category: 'Allied & Wellness', sortOrder: 105,
      description: 'Accurate and timely diagnostics including ultrasound, X-ray, and lab tests, supported by modern equipment and skilled technicians for reliable results.' },
  ],
  ...
  locations: [
    {
      ...
      imageUrl: '/hospitals/kochi.webp',
      promoImageUrl: '/banners/kochi-ivf-father.jpg',
      promoAlt:
        'Congrats! You are going to be a father — let your baby dream come true at Kinder Hospitals, with 15 years of IVF legacy. Call +91 484 666 0000.',
      promo2ImageUrl: '/banners/home-ivf-mother.jpg',
      promo2Alt:
        'Congrats! You are going to be a mother — let your baby dream come true at Kinder Hospitals, with 15 years of IVF legacy. Call +91 484 666 0000.',
      sortOrder: 1,
      since: 'Since 2018',
    ...
    },
    {
      ...
      imageUrl: '/hospitals/cherthala.webp',
      sortOrder: 2,
      since: 'Since 2011',
    ...
    },
    {
      ...
      name: 'Kollam',
      slug: 'kollam',
      tagline: 'Where Every Tiny Heartbeat Is Cherished with Kindness',
      description:
      ...
      mapUrl: 'https://kinderkollam.com',
      imageUrl: '/hospitals/kollam.webp',
      heroImageUrl: '/hospitals/kollam.webp',
      sortOrder: 6,
      since: 'Since 2026',
  ...
  doctors: [
    ...
    // The Kinder Kollam team. Portraits are uploaded from the admin; the
    // doctor cards show initials until then.
    { id: 101, name: 'Dr. Reshmy R Pillai', designation: 'Consultant \u2014 Paediatrics', speciality: 'Paediatrics', location: 'Kollam', bio: 'MBBS, DCH, MRCPCH (UK)', imageUrl: '', sortOrder: 101 },
    { id: 102, name: 'Dr. Praveen Krishna K P', designation: 'Senior Consultant \u2014 Neonatology', speciality: 'Neonatology', location: 'Kollam', bio: 'MBBS, MD (Paediatrics), DM Neonatology', imageUrl: '', sortOrder: 102 },
    { id: 103, name: 'Dr. Manju V K', designation: 'Consultant \u2014 Obstetrics & Gynaecology · Laparoscopic Surgeon', speciality: 'Obstetrics', location: 'Kollam', bio: 'MBBS, MS, DNB (O&G), MNAMS, FMAS', imageUrl: '', sortOrder: 103 },
    { id: 104, name: 'Dr. Jilu Fathima Y', designation: 'Junior Consultant \u2014 Paediatrics', speciality: 'Paediatrics', location: 'Kollam', bio: 'MBBS, MD (Paediatrics)', imageUrl: '', sortOrder: 104 },
    { id: 105, name: 'Dr. Beegam Raheena', designation: 'Consultant \u2014 Obstetrics & Gynaecology', speciality: 'Obstetrics', location: 'Kollam', bio: 'MBBS, DNB (OBG), MNAMS, FMIS', imageUrl: '', sortOrder: 105 },
    { id: 106, name: 'Dr. Shalini Mahapatra', designation: 'Consultant \u2014 Fetal Medicine', speciality: 'Fetal Medicine', location: 'Kollam', bio: 'MBBS, MS (Obstetrics & Gynaecology), DNB, PDF (Fetal Medicine)', imageUrl: '', sortOrder: 106 },
    { id: 107, name: 'Dr. Deepthi Prem', designation: 'Senior Consultant \u2014 Obstetrics and Gynaecology', speciality: 'Obstetrics', location: 'Kollam', bio: 'MBBS, MD (O&G)', imageUrl: '', sortOrder: 107 },
    { id: 108, name: 'Dr. Karthik Prakash', designation: 'Junior Consultant \u2014 Orthopaedics', speciality: 'Orthopaedics', location: 'Kollam', bio: 'MBBS, MS Orthopaedics', imageUrl: '', sortOrder: 108 },
    { id: 109, name: 'Dr. Vijayamohan N', designation: 'Visiting Consultant \u2014 Dermatology', speciality: 'Dermatology', location: 'Kollam', bio: 'MBBS, DVD, DNB', imageUrl: '', sortOrder: 109 },
  ],
